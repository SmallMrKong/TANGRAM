...
//
//
//	return CefLifeSpanHandler::OnBeforePopup(browser, frame, target_url, target_frame_name, (CefPopupFeatures)popupFeatures, (CefWindowInfo)windowInfo, (CefRefPtr<CefClient>)client, settings, no_javascript_access);
//}
